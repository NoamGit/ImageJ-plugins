...
/**
 * @link: http://www.maxplanckflorida.org/fitzpatricklab/software/cellMagicWand/index.html
@author: Theo Walker
* */
...
public class Cell_Magic_Wand_Tool extends PlugInTool {
	...
	public PolygonRoi makeRoi(int x, int y, ImagePlus imp){
		...
		PolarTransform radiusFind;
		try {
			radiusFind = new PolarTransform(imp, x, y, rMin, rMax, Constants.PIXELS_PER_R_SAMPLE, Constants.THETA_SAMPLES_FOR_RADIUS_FINDING, cellsAreBright);
		}
		catch(Exception e){
			return null;
		}
	...
	public static void main(String[] args){
		...
		new CommandLine(args); //everything just runs in the constructor, because idiomatic Java's too much work
	}
